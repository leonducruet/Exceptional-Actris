...
From eactris Require Export proto channel.
...
Section classes.
  ...
  Global Instance proto_normalize_swap {TT1 TT2} d a m m'
      (tv1 : TT1 -t> V) (tP1 : TT1 -t> iProp Σ) (tm1 : TT1 -t> iMsg Σ)
      (tv2 : TT2 -t> V) (tP2 : TT2 -t> iProp Σ)
...
Lemma tac_wp_recv `{!chanG Σ, !heapGS Σ} {TT : tele} Δ i j K c p m (tv : TT -t> val) tP tP' tp Φ :
  ...
  envs_entails Δ (WP fill K (atomic_channel.recv c) {{ Φ }}).
Proof.
